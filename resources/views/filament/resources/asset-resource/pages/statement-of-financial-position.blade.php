    ...
    <table class="min-w-full border rounded-lg bg-white dark:bg-gray-800">
        ...
        <tbody>
            <tr class="hover:bg-gray-50 dark:hover:bg-gray-700/50">
                ...
                <td class="border px-4 py-2 text-right border-gray-300 dark:border-gray-600">
                    {{ number_format($cashAmount, 2) }}</td>
                <td class="border px-4 py-2 border-gray-300 dark:border-gray-600">Liabilities</td>
                <td class="border px-4 py-2 text-right border-gray-300 dark:border-gray-600">
