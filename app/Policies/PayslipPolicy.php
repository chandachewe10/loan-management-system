...
class PayslipPolicy
{
    ...
    {
        return $user->can('delete_any_payslip');
    }
    ...
    {
        return $user->can('force_delete_payslip');
    }
    ...
    {
        return $user->can('force_delete_any_payslip');
    }
    ...
    {
        return $user->can('restore_payslip');
    }
    ...
    {
        return $user->can('restore_any_payslip');
    }
    ...
    {
        return $user->can('replicate_payslip');
    }
    ...
    {
        return $user->can('reorder_payslip');
    }
}
