...
class LoanResource extends Resource
{
    ...
    public static function form(Form $form): Form
    {
        ...
        return $form->schema([
            Forms\Components\Select::make('from_this_account')->label('From this Account')->prefixIcon('fas-wallet')->options($options->pluck('label', 'value')->toArray())->required()->searchable(),
            Forms\Components\Select::make('loan_status')
                ...
                ->required(),
            Forms\Components\Select::make('borrower_id')->prefixIcon('heroicon-o-user')->relationship('borrower', 'full_name')->preload()->searchable()->required(),
        ...
        return $table
            ->columns([
                ...
                Tables\Columns\TextColumn::make('loan_status')
                    ...
                    ->searchable(),
                Tables\Columns\TextColumn::make('principal_amount')->label('Principle Amount')->money('PHP')->badge()->sortable()->searchable(),
            ...
            ->filters([
                Tables\Filters\SelectFilter::make('loan_status')->options([
                    'requested' => 'Requested',
                    'processing' => 'Processing',
                    'approved' => 'Approved',
                    'denied' => 'Denied',
